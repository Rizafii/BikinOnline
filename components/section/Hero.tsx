...
export default function Hero() {
  return (
    <header className="w-full relative min-h-170">
      <Image
        width={1920}
        height={1080}
      ...
      <div className="container mx-auto px-48 pt-20 h-full min-h-150 flex items-center justify-center">
        <div className="left flex flex-col gap-6 w-full items-start text-start">
          <h1 className="text-4xl drop-shadow-lg font-bold text-background max-w-160 leading-12 tracking-normal">
            Partner Digital Terpercaya untuk Pengembangan Website Bisnis Anda
          </h1>
          <p className="text-background drop-shadow-lg max-w-150 leading-6 tracking-normal">
